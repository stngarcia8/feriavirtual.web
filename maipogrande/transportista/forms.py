...
from .models import Vehicle, BidModel
    ...
    class Meta:
        ...
        widgets = {
            ...
            'VehiclePatent': TextInput(attrs={'size': '15', 'pattern': "[ÑA-Zña-z0-9]+$", 'minlength': 4,
                                              'oninvalid': "setCustomValidity('Ingrese una patente válida')",
                                              'oninput': "setCustomValidity('')"}),
            'VehicleModel': TextInput(attrs={'size': '15', 'minlength': 5, 'pattern': "[ña-zÑA-ZáéíóúÁÉÍÓÚ]+$",
                                             'oninvalid': "setCustomValidity('Ingrese un modelo válido')",
                                             'oninput': "setCustomValidity('')"}),
            'VehicleCapacity': NumberInput(attrs={'min': 1, 'pattern': "^[0-9]+$",
                                                  'oninvalid': "setCustomValidity('Ingrese una capacidad válida')",
                                                  'oninput': "setCustomValidity('')",
    ...
    class Meta:
        ...
        widgets = {
            ...
            'Value': NumberInput(attrs={'min': 1, 'pattern': "^[1-9]+$", 'max': '',
                                        'oninvalid': "setCustomValidity('Ingrese una propuesta válida')",
                                        'oninput': "setCustomValidity('')",
                                        'onkeypress': "return event.charCode >=46"}),
        }
