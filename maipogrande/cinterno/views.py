...
from .models import InternalOrder, ExportInternalProduct
...
class OrderListView(ListView):
    ...
    template_name = 'cinterno/orden-listar.html'
...
class OrderDetailView(DetailView):
    model = InternalOrder
    template_name = 'cinterno/orden-ver.html'
...
class OrderCreateView(CreateView):
    ...
    slug_field = 'User_id'
    slug_url_kwarg = 'User_id'
    template_name = 'cinterno/orden-registrar.html'
...
class OrderUpdateView(UpdateView):
    model = InternalOrder
    form_class = OrderForm
    template_name = 'cinterno/orden-editar.html'
...
class OrderDeleteView(DeleteView):
    model = InternalOrder
    template_name = 'cinterno/orden-eliminar.html'
...
def CargarOrdenesSinProcesar(request):
    ...
    return render(request, 'cinterno/home-interno.html')
